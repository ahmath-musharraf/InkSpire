...
const state = {
    ...
    productsData: [
        // Replace 'image' URLs below with your RAW GitHub links
        { name: '2026 Calendar Custom Design & Print', price: 'Contact Us', description: '350gsm matte laminated cards with sharp, vibrant colors.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Calender.jpg', category: 'Stationery & Office' },
        ...
        { name: 'Wedding Frame', price: 'Contact Us', description: 'High-quality 150gsm gloss paper, perfect for promotions.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_WeddingFrame.jpg', category: 'Marketing & Promo' },
        { name: 'Custom Invitation Design & Print', price: 'Contact Us', description: 'Durable, portable, and easy to set up for any event.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Invitation.jpg', category: 'Signage & Display' },
        ...
        { name: 'Stamp', price: 'LKR 799', description: 'Professionally designed notepads for office or client use.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Stamp.jpg', category: 'Stationery & Office' },
        { name: '3D Customized Number Plates', price: 'Contact Us', description: 'High-quality cotton t-shirts with custom screen printing.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_NumberPlate.jpg', category: 'Apparel & Textiles' },
        { name: 'Custom wedding Card Design & Print', price: 'Contact Us', description: 'Custom shape vinyl stickers, waterproof and durable.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Wedding%20Card.jpg', category: 'Marketing & Promo' },
        { name: 'Double-Side Engraved Wooden Key Tag', price: 'Contact Us', description: 'Eco-friendly tote bags with your custom design printed.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_KeyChain.jpg', category: 'Apparel & Textiles' },
    ],
    searchableData: [],
