...
const state = {
    siteData: {
        ...
        projects: [
            ...
            { category: 'Print & Marketing', title: 'IStore Bill Book Printing', description: 'High-quality bill books printed with precision, ensuring clear duplicates, durable binding, and a professional finish tailored for daily business operations.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_BillBook.jpg', link: 'https://www.facebook.com/share/p/17ZwUad4Wu/' },
            { category: 'Stationery & Branding', title: 'Fairy Magic Business Card Printing', description: 'Elegant and premium business cards crafted with vibrant colors, crisp details, and a refined layout to enhance brand identity and first impressions.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_BussCard.jpg', link: 'https://www.facebook.com/share/p/16cahbfoaA/'  },
            { category: 'Print & Marketing', title: 'Ritha International Certificate Printing', description: 'Professionally designed and printed certificates featuring rich colors, sharp detailing, and a premium finish ideal for academic and corporate recognitions.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Certificate.jpg', link: 'https://www.facebook.com/share/p/17cd7fvssB/'  },
            { category: 'Corporate Gifts', title: 'Homey Brownies Envelope Printing', description: 'Custom-designed envelopes with a clean, stylish aesthetic—perfect for product packaging, gift presentations, and enhancing brand appeal.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Envelope.jpg', link: 'https://www.facebook.com/share/p/1BcEAAMZVz/'  },
            { category: 'Event Branding', title: 'Invitation Printing', description: 'Beautifully printed invitations with premium textures and sharp detailing, ideal for weddings, corporate functions, and special events.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Inivi.jpg', link: 'https://www.facebook.com/share/p/14MrtEKdP9Q/'  },
            { category: 'Signages & Backdrops', title: 'Manzil Screen Printing', description: 'Premium-quality screen printing with durable inks and high-precision detailing, suitable for branding, decor, and long-lasting signage.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Quran.jpg', link: 'https://www.facebook.com/share/p/1BjwoG2wnX/'  },
        ],
        team: [
            // Replace 'image' URLs below with your RAW GitHub links
            ...
            { name: 'Mohamed Aakif', role: 'Designer', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Aaqif.jpg' },
        ],
        testimonials: [
    ...
    productsData: [
        // Replace 'image' URLs below with your RAW GitHub links
        { name: '2026 Calendar – Custom Design & Print', price: 'Contact Us', description: 'Premium 350gsm matte-laminated calendars, designed with sharp and vibrant colors. Perfect for corporate gifting or brand visibility throughout the year.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Calender.jpg', category: 'Marketing & Promo' },
        { name: 'Premium Business Cards', price: 'Contact Us', description: 'Ultra-durable 350gsm matte-laminated business cards with crisp printing and professional finishing, ideal for making a lasting first impression.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_BusinessCard.jpg', category: 'Stationery & Office' },
        { name: 'Wedding Frame', price: 'Contact Us', description: 'Beautifully crafted personalized wedding frames printed on high-quality gloss materials—perfect for gifting or preserving cherished memories.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_WeddingFrame.jpg', category: 'Gifts & Personal' },
        { name: 'Custom Invitation – Design & Print', price: 'Contact Us', description: 'Elegantly designed invitations tailored for weddings, events, and celebrations. Printed with premium finishes to match any theme or occasion.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Invitation.jpg', category: 'Signage & Display' },
        { name: 'Custom Mugs', price: 'Contact Us', description: 'Personalized ceramic mugs with high-quality printing—ideal for corporate branding, gifting, or everyday use.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Mug.jpg', category: 'Gifts & Personal' },
        { name: 'Personalized Stamp', price: 'LKR 799', description: 'High-quality custom rubber stamps designed for professional or personal use. Clear impressions and long-lasting durability.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Stamp.jpg', category: 'Stationery & Office' },
        { name: '3D Customized Number Plates', price: 'Contact Us', description: 'Premium 3D embossed number plates with a sleek custom finish. Durable, stylish, and built to withstand any weather.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_NumberPlate.jpg', category: 'Apparel & Textiles' },
        { name: 'Custom Wedding Card – Design & Print', price: 'Contact Us', description: 'Elegant and fully customizable wedding cards designed to match your theme. Printed on premium materials with attention to detail.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_Wedding%20Card.jpg', category: 'Marketing & Promo' },
        { name: 'Double-Side Engraved Wooden Key Tag', price: 'Contact Us', description: 'Premium double-sided engraved wooden key tags, perfect for personalized gifting, souvenirs, or branding with a natural touch.', image: 'https://raw.githubusercontent.com/ahmath-musharraf/InkSpire/refs/heads/main/Images/ink_KeyChain.jpg', category: 'Apparel & Textiles' },
    ],
    searchableData: [],
...
function renderFooter() {
    ...
    const content = createElement('div', { className: 'container mx-auto px-6 py-12' }, [
        ...
        createElement('div', { className: 'mt-12 border-t border-brand-secondary/30 pt-8 text-center text-gray-500' }, [
            createElement('p', {}, [`© ${new Date().getFullYear()} INK Spire. All Rights Reserved. Created By Mushi Editz`])
        ])
    ]);
    container.appendChild(content);
}
